...
class _CustomShadowTextFieldState extends State<CustomShadowTextField> {
        ...
        children: [
          widget.isMandatory
            ...
            TextSpan(
              ...
              : Text(
            widget.labelText!,
            style: widget.stickyLabelStyle ?? getRegularStyle(color: Colors.black),
          ),
          const SizedBox(
            height: 10,
          ),
  ...
  Widget _getTextField() {
    return TextFormField(
        ...
        //controller: textEditingController,
        style: widget.labelStyle ?? getRegularStyle(color: Colors.black),
        cursorWidth: 2,
        showCursor: true,
        ...
        decoration: InputDecoration(
            ...
            hintStyle: widget.hintStyle ??getRegularStyle(color: Colors.black)));
  }
